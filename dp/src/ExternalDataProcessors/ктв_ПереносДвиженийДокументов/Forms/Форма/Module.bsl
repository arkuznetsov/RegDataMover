...
Функция ПолучитьСписокДокументовДляСохранения()
	...
	Возврат ПреобразованиеДанных().ЗаписатьОписаниеОбъектаВJSON(СписокДокументов.ВыгрузитьЗначения());
...
Процедура ЗагрузитьСписокДокументовНаСервере(ДанныеСтрокой)
	...
	СписокДокументов.ЗагрузитьЗначения(ПреобразованиеДанных().ПрочитатьОписаниеОбъектаИзJSON(ДанныеСтрокой));
